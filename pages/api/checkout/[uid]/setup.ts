...
const handler = async (req: any, res: any) => {
    ...
    if (req.method === 'POST') {
        try {
            ...
            console.log('id::::', paymentIntent.payment_method_details)
            ...
            setDoc(doc(db, 'users', uid), { pey: "30000" }, { merge: true })
            console.log('id::::', paymentIntent.payment_method_details.receipt_url)
        } catch (err: any) {
