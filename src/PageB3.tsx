                                        ...
                                        .map((tomare: TomareState) => {
                                            ...
                                            const fetchTarget1 = async () => {
                                                setDoc(doc(db, 'users', users.uid, 'tomare', `${tomare.gappi}${tomare.am_pm}`), {
                                                    menu: "make", yoyakuMenu: "ケアメイク", make: true, nail: false, este: false, aroma: false, chip: 0, tanka: 0, quantity: 0, star: 0, checked: true, pay: 0, yoyakuUid: user.uid, yoyakuIcon: user.icon, yoyakuId: users.uid + user.uid + tomare.tomareId, timestamp: now, img_befor: "", img_after: "", come_befor: "", come_after: "",
                                                }, { merge: true })
                                                alert("登録しました！")
                                                fetchTomare()
                                            };
                                            const fetchTarget2 = async () => {
                                                setDoc(doc(db, 'users', users.uid, 'tomare', `${tomare.gappi}${tomare.am_pm}`), {
                                                    menu: "nail", yoyakuMenu: "ケアネイル", make: false, nail: true, este: false, aroma: false, chip: 0, tanka: 0, quantity: 0, star: 0, checked: true, pay: 0, yoyakuUid: user.uid, yoyakuIcon: user.icon, yoyakuId: users.uid + user.uid + tomare.tomareId, timestamp: now, img_befor: "", img_after: "", come_befor: "", come_after: "",
                                                }, { merge: true })
                                                alert("登録しました！")
                                                fetchTomare()
                                            };
                                            const fetchTarget3 = async () => {
                                                setDoc(doc(db, 'users', users.uid, 'tomare', `${tomare.gappi}${tomare.am_pm}`), {
                                                    menu: "este", yoyakuMenu: "ケアエステ", make: false, nail: false, este: true, aroma: false, chip: 0, tanka: 0, quantity: 0, star: 0, checked: true, pay: 0, yoyakuUid: user.uid, yoyakuIcon: user.icon, yoyakuId: users.uid + user.uid + tomare.tomareId, timestamp: now, img_befor: "", img_after: "", come_befor: "", come_after: "",
                                                }, { merge: true })
                                                alert("登録しました！")
                                                fetchTomare()
                                            };
                                            const fetchTarget4 = async () => {
                                                setDoc(doc(db, 'users', users.uid, 'tomare', `${tomare.gappi}${tomare.am_pm}`), {
                                                    menu: "este", yoyakuMenu: "アロマケア", make: false, nail: false, este: false, aroma: true, chip: 0, tanka: 0, quantity: 0, star: 0, checked: true, pay: 0, yoyakuUid: user.uid, yoyakuIcon: user.icon, yoyakuId: users.uid + user.uid + tomare.tomareId, timestamp: now, img_befor: "", img_after: "", come_befor: "", come_after: "",
                                                }, { merge: true })
                                                alert("登録しました！")
                                                fetchTomare()
                                            };
